    ...
    <div className="container-custom py-8 max-w-2xl">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium mb-1">آدرس عکس محصول</label>
            <input
              type="text"
              name="imageUrl"
            ...
            <p className="text-xs text-gray-500 mt-1">
              می‌توانید از آدرس اینترنتی عکس استفاده کنید. اگر خالی بگذارید، آیکون پیش‌فرض نمایش داده می‌شود.
            </p>
          </div>
